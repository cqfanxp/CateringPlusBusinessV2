...
#define selfGreen [UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:0.8]
//iPhone 6
...
-(instancetype)init{
    if (self = [super init]) {
        ...
        _min_arr=@[@"00",@"05",@"10",@"15",@"20",@"25",@"30",@"35",@"40",@"45",@"50",@"55"];
...
-(void)createUI{
    ...
    white_view.backgroundColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1.0];
//    white_view.layer.cornerRadius=10;
    white_view.layer.borderWidth = 1;
    white_view.layer.borderColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1.0].CGColor;
    ...
    //   分割线
    UILabel * button_line1=[[UILabel alloc]initWithFrame:CGRectMake(0,60, 375-100, 1)];
    button_line1.backgroundColor=[UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:0.5];
    [white_view addSubview:button_line1];
